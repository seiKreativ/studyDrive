...
public class TableLectures extends JPanel {
	...
	private LectureContainer container;

	@SuppressWarnings("serial")
	public TableLectures(LectureContainer container) {
		...
		String header[] = new String[] { "Sem", "Name", "LPs" };
...
//			}
		...
		tblTaskList.getColumn("Sem").setPreferredWidth(15);
		tblTaskList.getColumn("Name").setPreferredWidth(210);
		tblTaskList.getColumn("LPs").setPreferredWidth(15);
	...
	public void load() {
		if (container != null) {
			...
			for (int count = 1; count <= container.getSize(); count++) {
				Lecture e = container.getLectureByIndex(count - 1);
